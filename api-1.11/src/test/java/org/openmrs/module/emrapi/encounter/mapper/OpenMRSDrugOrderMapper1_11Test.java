...
public class OpenMRSDrugOrderMapper1_11Test {
    ...
    private final String orderReasonText = "has multiple side effects";
    ...
    public void shouldMapNewDrugOrders() throws ParseException {
        ...
        drugOrder.setOrderReasonText(orderReasonText);
        ...
        assertThat(openMrsDrugOrder.getOrderReasonNonCoded(),is(equalTo(orderReasonText)));
